...
//      { name: "Tour Collection", code: "tour_collection" },
//        { name: "Payment Outward", code: "payment_outward" },
//   ];
...
// // Replace with your actual Atlas connection string, database, and collection names
// const uri = 'mongodb+srv://admin:LfU5iVKGblIbeTf4@cluster0.bpbpxtd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
// const dbName = 'test';
// const collectionName = 'staffs';   // Change if your collection is named differently

// // The password hash to apply to all MRs without a password
// const defaultPasswordHash = '$2b$10$axLBrYsG2yWY1Bd4k9tAZecfhLMu3RoFTJwjgLLgyAI26XM0uMqcW';

// async function addPasswordToAllMRs() {
...
//     // Update all documents that do NOT have a password field
//     const result = await collection.updateMany(
//       { password: { $exists: false } },   // filter: documents without password
...
//   const client = new MongoClient('mongodb+srv://admin:ni6tP5N63U0Yxvdr@cluster0.2qjjhh8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0');
//   await client.connect();
//   const collection = client.db('test').collection('salesummaries');

//   const now = new Date();
//   const pipeline = [
//     { $match: { dueDate: { $lt: now }, dueAmount: { $gt: 0 } } },
//     { $group: { _id: null, count: { $sum: 1 }, totalDue: { $sum: "$dueAmount" } } }
//   ];
//   const result = await collection.aggregate(pipeline).toArray();

//   if (result.length > 0) {
//     console.log(`Overdue invoices: ${result[0].count}`);
//     console.log(`Total overdue amount: ${result[0].totalDue}`);
//   } else {
...
// getOverdueStats().catch(console.error);



// import { MongoClient } from 'mongodb';

// async function listInvoicesCreditDaysAndDueAmount() {
//   const client = new MongoClient('mongodb+srv://admin:ni6tP5N63U0Yxvdr@cluster0.2qjjhh8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0');
//   await client.connect();
//   const collection = client.db('test').collection('salesummaries');
...
//     $expr: {
//       $ne: [
//         { $subtract: ["$dueDate", "$recordingDate"] },
//         MS_30_DAYS
//       ]
//     }
//   };
...
//     .find(filter)
//     .project({ invoiceNumber: 1, creditDays: 1, dueAmount: 1, _id: 0 })
//     .toArray();

//   console.log(`Found ${invoices.length} invoices:\n`);
//   console.log('Invoice Number       | Credit Days | Due Amount');
//   console.log('---------------------|-------------|------------');

//   for (const doc of invoices) {
//     const inv = (doc.invoiceNumber || 'N/A').padEnd(20);
//     const cd  = String(doc.creditDays ?? 'N/A').padEnd(11);
//     const da  = (doc.dueAmount != null ? doc.dueAmount.toFixed(2) : 'N/A');
//     console.log(`${inv} | ${cd} | ${da}`);
//   }
