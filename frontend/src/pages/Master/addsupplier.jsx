...
const AddSupplier = () => {
 ...
 <div className="max-w-5xl mx-auto p-8 bg-white rounded-2xl shadow">
  <h2 className="text-2xl font-bold mb-6 text-gray-800">Add New Suppliers</h2>
      ...
      <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input
            ...
            placeholder="$ 0"
          />
          {errors.openingBalance && <p className="text-red-500 text-sm">{errors.openingBalance}</p>}
        </div>
        ...
        <div className="flex items-center gap-2">
          <div className="w-full">
            ...
            <input
              ...
              placeholder="$ 30"
            />
            {errors.creditPeriod && <p className="text-red-500 text-sm">{errors.creditPeriod}</p>}
          </div>
