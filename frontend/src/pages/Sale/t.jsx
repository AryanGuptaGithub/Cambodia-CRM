      ...
      <div className="container">
        <div className="flex justify-between items-center mb-4 flex-wrap gap-4">
          <div className="flex gap-3 items-center">
            ...
            <SaleExcelDownload
              data={downloadData}
              fileName={`sale_summary_${saleTypeTab}_${selectedTab}${isSampleDownloadFile ? '_sample' : ''}`}
              buttonText={isSampleDownloadFile ? "Download Sample Sales Excel" : "Download Sales Excel"}
            />
