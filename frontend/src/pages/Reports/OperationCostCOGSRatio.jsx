...
const OperationCostCOGSRatio = () => {
  ...
  const fetchOperationCostCOGSData = async (page = 1, search = searchTerm) => {
    setLoading(true);
    try {
      ...
      showToast(
        ...
        error.response?.data?.message ||
          "Failed to fetch operation cost COGS ratio data"
      );
      setData({
        summary: {
          operationCost: 0,
  ...
  const handlePageChange = (page) => {
    if (page >= 1 && page <= pagination.totalPages) {
      fetchOperationCostCOGSData(page);
    }
  };
  ...
  useEffect(() => {
    const delayDebounce = setTimeout(() => {
      fetchOperationCostCOGSData(1, searchTerm);
    }, 500);
  ...
  const renderSummaryCards = () => (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
      <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-red-500 border border-gray-200">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Expenses + Payroll</p>
          </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-purple-500 border border-gray-200">
        <div className="flex justify-between items-center">
          <div>
            <p className="text-sm text-gray-600">Operation Cost/COGS Ratio</p>
            <div
  ...
  const renderTableRow = (record, index) => {
    return (
      ...
      >
        ...
        <td className="p-3 text-sm text-gray-600">{formatDate(record.date)}</td>
                ...
                <td colSpan={getColSpan()} className="p-8 text-center">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <span className="text-gray-600">
                      Loading operation cost COGS ratio data...
                    </span>
                ...
                <td colSpan={getColSpan()} className="p-8 text-center">
                  ...
                  <p className="text-gray-500 max-w-md mx-auto">
                    ...
                    (!customDateRange.startDate || !customDateRange.endDate)
                      ...
                      : "No operation cost COGS ratio data available for the selected date range."}
                  </p>
                </td>
              </tr>
            )}
