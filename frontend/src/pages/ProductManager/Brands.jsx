...
const initialBrands = [
  ...
  },
  {
    id: 3,
    name: "Sony",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Sony_Logo.svg/512px-Sony_Logo.svg.png",
  },
];
...
const paginatedBrands = filteredBrands.slice(indexOfFirstItem, indexOfLastItem);
const totalPages = Math.ceil(filteredBrands.length / itemsPerPage);
  ...
  const handleSelectAll = () => {
    ...
    if (selectedIds.length === allFilteredIds.length) {
      ...
      setSelectedIds(allFilteredIds); // Select all
    }
  };
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="w-20 h-20 border border-dashed rounded-lg flex items-center justify-center cursor-pointer bg-gray-50">
            <label htmlFor="brandImageUpload" className="cursor-pointer text-3xl text-gray-400">
           {newBrand.image ? (
  <img
